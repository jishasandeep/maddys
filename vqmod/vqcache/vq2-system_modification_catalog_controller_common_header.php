...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['cart_icon'] = $server . 'image/maddy/shopcart.png';
		$data['wishlist_icon'] = $server . 'image/maddy/wishlist.png';
		$data['login_icon'] = $server . 'image/maddy/login.png';
		$data['maddy_img'] = $server . 'image/maddy/maddy.png';
		$data['freeship_cod'] = $server . 'image/maddy/freeship_cod.png';
		$data['gifts_img'] = $server . 'image/maddy/gifts.png';
		...
		if (isset($this->session->data['wishlist']) ) {
					...
					$data['text_wishlist'] = $this->language->get('text_wishlist_0');
		}
		...
		$data['text_download'] = $this->language->get('text_download');
			...
			$data['text_feedextrack'] = $this->language->get('text_feedextrack');
			$data['feedextrack'] = $this->url->link('account/feedextrack', '', 'SSL');
